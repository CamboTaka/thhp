...
// --------------------------------
// トップページ
$data["osusume"] = item_list(0, 0, 0, 7, 0);	// おすすめ
//
$data["list0"] = item_list(0, 0, 0, 6, 0);	// 全種類
$data["list1"] = item_list(1, 0, 0, 10, 0);	// 種類1
$data["list2"] = item_list(2, 0, 0, 10, 0);	// 種類2
$data["list3"] = item_list(3, 0, 0, 10, 0);	// 種類3
$data["list4"] = item_list(4, 0, 0, 5, 0);	// 種類4
$data["list5"] = item_list(5, 0, 0, 5, 0);	// 種類5
$data["list6"] = item_list(6, 0, 0, 10, 0);	// 種類6
$data["list7"] = item_list(7, 0, 0, 5, 0);	// 種類7
//
$data["newinfo"] = get_newinfo();
//
